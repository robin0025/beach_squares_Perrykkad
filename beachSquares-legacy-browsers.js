...
function which_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    which_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function confidence_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    confidence_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function agent_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    agent_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function feed_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    feed_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function warning_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    warning_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function warning_mouse_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    warning_mouse_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function trial_instructRoutineBegin(snapshot) {
  return function () {
    ...
    trial_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function which_objRoutineBegin(snapshot) {
  return function () {
    ...
    which_objComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function agentRoutineBegin(snapshot) {
  return function () {
    ...
    agentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function warning_mouseRoutineBegin(snapshot) {
  return function () {
    ...
    warning_mouseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
